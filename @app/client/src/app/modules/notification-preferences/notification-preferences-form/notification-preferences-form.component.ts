...
@Component({
  selector: 'app-notification-preferences-form-component',
  templateUrl: './notification-preferences-form.component.html',
  styleUrls: ['./notification-preferences-form.component.scss']
})
export class NotificationPreferencesFormComponent implements OnInit {
