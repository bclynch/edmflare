...
GRANT USAGE ON SCHEMA app_hidden TO trosky_visitor;
...
GRANT USAGE ON SCHEMA app_public TO trosky_visitor;
...
GRANT SELECT ON TABLE app_public.users TO trosky_visitor;
...
GRANT UPDATE(username) ON TABLE app_public.users TO trosky_visitor;
...
GRANT UPDATE(name) ON TABLE app_public.users TO trosky_visitor;
...
GRANT UPDATE(avatar_url) ON TABLE app_public.users TO trosky_visitor;
...
GRANT ALL ON FUNCTION app_public.change_password(old_password text, new_password text) TO trosky_visitor;
...
GRANT SELECT,DELETE ON TABLE app_public.user_emails TO trosky_visitor;
...
GRANT INSERT(email) ON TABLE app_public.user_emails TO trosky_visitor;
...
GRANT SELECT,DELETE ON TABLE app_public.user_authentications TO trosky_visitor;
...
GRANT SELECT,USAGE ON SEQUENCE app_public.user_authentications_id_seq TO trosky_visitor;
...
GRANT SELECT,USAGE ON SEQUENCE app_public.user_emails_id_seq TO trosky_visitor;
...
GRANT SELECT,USAGE ON SEQUENCE app_public.users_id_seq TO trosky_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE trosky IN SCHEMA app_hidden REVOKE ALL ON SEQUENCES  FROM trosky;
ALTER DEFAULT PRIVILEGES FOR ROLE trosky IN SCHEMA app_hidden GRANT SELECT,USAGE ON SEQUENCES  TO trosky_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE trosky IN SCHEMA app_public REVOKE ALL ON SEQUENCES  FROM trosky;
ALTER DEFAULT PRIVILEGES FOR ROLE trosky IN SCHEMA app_public GRANT SELECT,USAGE ON SEQUENCES  TO trosky_visitor;
